...
![](http://ph598qxe6.bkt.clouddn.com/macSkills/macSkills_01.png)

很多刚接触 Mac 电脑的新人，都会因为 Mac 默认不能写入外接磁盘 \(NTFS格式\) 而苦恼，这个问题或多或少的给你的工作或者生活带来一些困扰；确切的说就是 Mac 可以从一个通过 USB 连接的磁盘 ( U 盘或者移动硬盘这里统称为外接磁盘)里拷贝文件到 Mac 电脑里，但是反过来却不可以，也就是从 Mac 里拷贝文件到外接磁盘。因为大部分的磁盘初始格式都是 NTFS ，Mac 默认未开启 NTFS 格式的文件写入。本篇将介绍 Mac 读写外接磁盘的5种方案，相信总有一种方案适合你。 
...
<img src="http://ph598qxe6.bkt.clouddn.com/macSkills/macSkills_08.png" width = "20%" />  
...
<img src="http://ph598qxe6.bkt.clouddn.com/macSkills/macSkills_06.png" width = "50%" />  

安装后一般都要重启电脑，重启后基本就可以使用了，个别第一次安装的可能勾选了 `只读模式安装` 勾选去掉就可以了。  

<img src="http://ph598qxe6.bkt.clouddn.com/macSkills/macSkills_07.png" width = "50%" />
...
<img src="http://ph598qxe6.bkt.clouddn.com/macSkills/macSkills_09.png" width = "20%" />  

打开磁盘工具软件

<img src="http://ph598qxe6.bkt.clouddn.com/macSkills/macSkills_10.png" width = "50%" />
...
<img src="http://ph598qxe6.bkt.clouddn.com/macSkills/macSkills_11.png" width = "20%" />
...
<img src="http://ph598qxe6.bkt.clouddn.com/macSkills/macSkills_12.png" width = "20%" />  
...
<img src="http://ph598qxe6.bkt.clouddn.com/macSkills/macSkills_02.png" width = "50%" />  
...
diskutil list
```
<img src="http://ph598qxe6.bkt.clouddn.com/macSkills/macSkills_03.png" width = "60%" />  
...
<img src="http://ph598qxe6.bkt.clouddn.com/macSkills/macSkills_05.png" width = 20%/>
...
<img src="http://ph598qxe6.bkt.clouddn.com/macSkills/macSkills_04.png" width = 20%/>
