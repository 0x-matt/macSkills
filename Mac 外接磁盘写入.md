...
安装后一般都要重启电脑，重启后基本就可以使用了，个别第一次安装的可能勾选了 `只读模式打开` 勾选去掉就可以了。
...
### 6. 关于安装破解软件
还有个特别的办法就是安装破解版本，也许你早就想说，安装个破解版本不就解决了吗？更有可能你阅读本文的目的是想找个下载破解版本的链接，那可能让你失望了。 
...
1. 在能力范围内尽量先考虑付费，比如买个 Alfred Charles 等还是可以的，都 100 多块。
2. 找其他方案代替，比如 NTFS 写入问题，可以格式化为 exFAT，可以购买希捷的硬盘，还可以用免费的 Fuse for Mac 加两行命令。
