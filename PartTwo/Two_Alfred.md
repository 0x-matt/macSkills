##  Alfred 软件  
 不记得是哪一年的夏天，我蹲在 wc ，用多看阅读看着池建强老师的《人生元编程》(感谢池老师和他的书)，读到了 Mac 上的神兵利器：Alfred。从此我就迷恋上了 Alfred，也记住了那次 wc；如果身边用 Mac 的程序员没有 Alfred 就会被我在心里鄙视一下，现在想想自己也应该被同鄙视过；嗯，鄙视的对。 后来我付费购买了正版，然后开始鄙视还在使用免费或者破解版的人 🤔。Alfred 是 Mac 上的最强的工作流软件，它几乎 Mac 一切程序和开始的入口，是 Mac 的大管家。有了它，你的 Mac 生涯才算完整。  
...
<img src="http://ph598qxe6.bkt.clouddn.com/alfred_02.png" width='60%'/>
...
1. 计算器:    
<img src="http://ph598qxe6.bkt.clouddn.com/alfred_01.png" width='60%'/>
...
`in : 文件内查找`    
find 示例图片:     
<img src="http://ph598qxe6.bkt.clouddn.com/alfred_06.png" width='60%'/>

3. 启动软件  
<img src="http://ph598qxe6.bkt.clouddn.com/alfred_05.png" width='60%'/>

以上功能你可能觉得系统自带的 Spotlight 也有，那么我们展示一些 Spotlight 没有的功能

1. 锁屏  
<img src="http://ph598qxe6.bkt.clouddn.com/alfred_12.png" width='60%'/>

2. 关机  
<img src="http://ph598qxe6.bkt.clouddn.com/alfred_13.png" width='60%'/>

3. 退出所有程序  
<img src="http://ph598qxe6.bkt.clouddn.com/alfred_14.png" width='60%'/>

4. 清空废纸篓  
<img src="http://ph598qxe6.bkt.clouddn.com/alfred_15.png" width='60%'/>
...
快速查单词  
<img src="http://ph598qxe6.bkt.clouddn.com/alfred_16.png" width='60%'/>  

查询天气  

<img src="http://ph598qxe6.bkt.clouddn.com/alfred_11.png" width='60%'/>  

一名会计工作者使用 Alfred 快速转换大写的 RMB    

<img src="http://ph598qxe6.bkt.clouddn.com/alfred_10.png" width='60%'/>  

一名设计人员使用 Alfred 来取色    

<img src="http://ph598qxe6.bkt.clouddn.com/alfred_07.png" width='60%'/>  

另一名程序员要用 Alfred 快速生成 .gitignore    

<img src="http://ph598qxe6.bkt.clouddn.com/alfred_09.png" width='60%'/>  

一名 Xcode 程序员使用 Alfred 快速清理 DerivedData    

<img src="http://ph598qxe6.bkt.clouddn.com/alfred_04.png" width='60%'/>  
...
<img src="http://ph598qxe6.bkt.clouddn.com/alfred_03.png" width='60%'/>

老版本的先快捷键呼出 Alfred 输入框，点击输入框的右上角的小齿轮。 

<img src="http://ph598qxe6.bkt.clouddn.com/alfred_22.png" width='60%'/>
...
<img src="http://ph598qxe6.bkt.clouddn.com/alfred_27.png" width='70%'/>   

Features 除了上边展示的这些易用的功能，我们还可以自定义其他简单的快捷搜索，比如快速用`京东`搜索某商品。  

<img src="http://ph598qxe6.bkt.clouddn.com/alfred_18.png" width='60%'/>    

上图所展示的行为是自动打开浏览器，展示京东的搜索结果；    

<img src="http://ph598qxe6.bkt.clouddn.com/alfred_19.png" width='60%'/>

完成这个配置我们只需要做几个简单的配置:   
1. 在 Features 中有个 web search 选项；
2. 点击右下角的 Add Custom Search
3. 在弹出框里写入 url 来查询，定义使用的快捷键。
<img src="http://ph598qxe6.bkt.clouddn.com/alfred_17.png" width='60%'/>  

如何获得 Search URL ？
> 我们需要先打开浏览器去京东官网，进行一次正常搜索查找，查找的内容可随意，搜索后，拷贝浏览器地址栏的地址，比如用京东搜索手机，浏览器地址栏的 URL 如下：    
><img src="http://ph598qxe6.bkt.clouddn.com/alfred_21.png" width='60%'/>  
...
<img src="http://ph598qxe6.bkt.clouddn.com/alfred_28.png" width='60%'/>
...
<img src="http://ph598qxe6.bkt.clouddn.com/alfred_20.png" width='60%'/> 
...
**编写一个自己的 workflow 主要工作**

如果上边的英文教程看着吃力的话，我写了个简明的中文教程；

1. 打开 workflow 界面，点击左下角的 `+`， 然后选 Blank Workflow ；
<img src="http://ph598qxe6.bkt.clouddn.com/alfred_23.png" width='70%'/>  
...
<img src="http://ph598qxe6.bkt.clouddn.com/alfred_24.png" width='70%'/>  

3. 添加 Filter Script  
<img src="http://ph598qxe6.bkt.clouddn.com/alfred_25.png" width='70%'/>  


4. 完成你的编码  
<img src="http://ph598qxe6.bkt.clouddn.com/alfred_26.png" width='70%'/>
